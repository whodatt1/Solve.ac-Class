...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < M; i++) {
            ...
            if ((49 <= param.charAt(0) && param.charAt(0) <= 57) || (49 <= param.charAt(param.length() - 1) && param.charAt(param.length() - 1) <= 57)) {
                sb.append(map.get(Integer.parseInt(param))).append("\n");
            } else {
                sb.append(map2.get(param)).append("\n");
            }
        }
